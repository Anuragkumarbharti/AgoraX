-- Migration: 202608070021_fix_min_function_postgres_error.sql
-- Description: Fix PostgreSQL error 'function min(integer, integer) does not exist' by replacing min() with LEAST() in process_room_dual_progress RPC.
