-- Migration: 202608070023_fix_gift_record_icon_field_error.sql
-- Description: Fix PostgreSQL error 'record v_gift_record has no field icon_url' by using coalesce with to_jsonb for icon/icon_url.
...
begin
  ...
  -- Extract icon safely (gift_catalog column is icon, safely fall back if icon_url is present)
