...
class _ExploreScreenState extends State<ExploreScreen>
  ...
  final List<String> _tabs = ['All', 'Posts', 'Questions', 'Communities', 'Users'];

  // ── Mock data ──
  final List<Post> _posts = List.generate(10, (i) => Post(
    id: 'p$i',
    userId: 'u$i',
    communityId: 'comm$i',
    content: [
  ...
  final List<User> _postAuthors = List.generate(10, (i) => User(
    id: 'u$i',
    username: ['flutter_dev', 'ai_coder', 'algomaster', 'webwizard', 'oss_hero',
               'sde_ninja', 'netguru', 'rustacean', 'distrib_sys', 'voice_builder'][i % 10],
    email: '',
    displayName: ['Rohan Sharma', 'Priya Mehta', 'Arjun Singh', 'Kavya Nair', 'Dev Patel',
                  'Ananya Roy', 'Karan Joshi', 'Shreya Das', 'Vikram Menon', 'Aditya Kumar'][i % 10],
    avatar: [
    ...
    badges: i % 2 == 0 ? ['🏆 Top Contributor', '🎤 Voice Host'] : ['💡 Problem Solver'],
    levelTitle: i < 3 ? 'Explorer' : i < 7 ? 'Expert' : 'Legend',
  ));

  final List<Question> _questions = List.generate(8, (i) => Question(
    id: 'q$i',
    userId: 'u$i',
    communityId: 'flutter',
    title: [
  ...
  final List<Community> _communities = List.generate(6, (i) {
    final names = ['Flutter India 🦋', 'AI & ML Hub 🤖', 'DSA Grinders 🧠',
                   'Web Dev Café ☕', 'Open Source 🌍', 'UPSC Aspirants 📚'];
    final descs = [
    ...
    return Community(
      ...
      name: names[i],
      description: descs[i],
      category: ['Technology', 'AI', 'Education', 'Technology', 'Open Source', 'Education'][i],
      type: 'public',
      owner: 'admin',
      admins: [],
      members: [],
  ...
  final List<User> _users = List.generate(8, (i) => User(
    id: 'usr$i',
    username: ['top_coder', 'flutter_queen', 'ai_wizard', 'open_src_king',
               'dsa_grinder', 'react_dev', 'cloud_arch', 'mobile_guru'][i],
    email: '',
    displayName: ['Rahul Tiwari', 'Sneha Kapoor', 'Nikhil Gupta', 'Tanvi Shah',
                  'Mohit Yadav', 'Ritika Singh', 'Saurabh Verma', 'Pooja Mishra'][i],
    avatar: [
          ...
          children: [
                  ...
                  child: ClipRRect(
                    ...
                    child: author.avatar != null && author.avatar!.isNotEmpty
                        ? CachedNetworkImage(
                            ...
                            errorWidget: (context, url, error) => _buildInitialsAvatar(author, radius: 20),
                          )
            ...
            Row(
              children: [
                ...
                _postAction(Icons.chat_bubble_outline,
                    _formatNumber(post.comments), AppTheme.textTertiary),
                const SizedBox(width: 18),
                _postAction(Icons.repeat_rounded,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _qStat(Icons.arrow_upward_rounded, _formatNumber(q.upvotes),
                ...
                ClipRRect(
                  ...
                  child: u.avatar != null && u.avatar!.isNotEmpty
                      ? CachedNetworkImage(
                          ...
                          errorWidget: (context, url, error) => _buildInitialsAvatar(u, radius: 26),
                        )
