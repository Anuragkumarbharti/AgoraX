...
class _VipPurchaseScreenState extends State<VipPurchaseScreen> {
  ...
  final Map<int, List<String>> benefitsMatrix = {
    1: [
      ...
      'VIP Name Color & Badge',
      '5% Silver Coins Bonus',
      'Basic VIP Special Gifts',
      'Priority Queue in Events',
      'Special Welcome Animation',
      'Exclusive Daily Rewards',
    ],
    2: [
      'Animated Profile Border',
      'Animated Avatar Ring',
      '8% Silver Coins Bonus',
      'VIP Sticker Pack',
      'Special Profile Layout Theme',
      'Premium Custom Reactions',
    ],
    3: [
      'Exclusive Golden Username',
      'Voice Room Join Announcement',
      'Animated Chat Bubble styles',
      '12% Silver Coins Bonus',
      'Premium Room Backgrounds',
      'Exclusive Device Wallpapers',
    ],
    4: [
      'Luxury Diamond Border',
      'Dynamic Profile Header Banner',
      'Private Custom VIP Badge',
      '20% Silver Coins Bonus',
      'VIP-Only Gift Store Access',
      'Priority Customer Service Support',
    ],
    5: [
      'Sleek Crystal Avatar Border',
      'Animated Username style',
      '25% Silver Coins Bonus',
      'Exclusive Gift Collection unlock',
      'Animated Follow/Add button',
      'Profile Spotlight Highlight effect',
    ],
    6: [
      'Rainbow Glowing Avatar Border',
      'Rainbow Username style',
      '30% Silver Coins Bonus',
      'Exclusive Entrance Effect in rooms',
      'VIP Exclusive Events access',
      'Animated Community Badges',
    ],
    7: [
      'Legendary Black Gold Crown Border',
      'Legendary Exit/Entry Animations',
      '35% Silver Coins Bonus',
      'VIP-Only seasonal Auctions access',
      'VIP-Only Lucky Draws & giveaways',
