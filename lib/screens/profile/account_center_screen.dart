    ...
    return _buildCategoryGroup(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 6,
          children: [
            _buildCollectionTag('Avatar Collection'),
            _buildCollectionTag('Frames Collection'),
            _buildCollectionTag('Pendants Collection'),
            _buildCollectionTag('Name Effects'),
            _buildCollectionTag('Chat Effects'),
            _buildCollectionTag('Entrance Effects'),
            _buildCollectionTag('Bubble Collection'),
            _buildCollectionTag('Background Collection'),
            _buildCollectionTag('Theme Collection'),
            _buildCollectionTag('Gift Collection'),
            _buildCollectionTag('Sticker Collection'),
          ],
        )
      ],
    );
  ...
  Widget _buildStoreSection() {
    return _buildCategoryGroup(
      ...
      children: [
        _buildFeatureTile(
          title: 'Open Store',
          subtitle: 'Go to AgoraX Marketplace',
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Agency: AgoraX Talent Network', style: GoogleFonts.poppins(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
