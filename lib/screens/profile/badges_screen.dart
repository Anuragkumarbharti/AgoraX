...
class _BadgesScreenState extends State<BadgesScreen>
  ...
  final List<Map<String, dynamic>> _allBadges = [
    ...
    },
    {
      ...
      'name': 'Early Adopter',
      'desc': 'Joined Creaniaa in the first 1000 users',
      'icon': '🚀',
      'category': 'Achievement',
      'rarity': 'Legendary',
      'rarityColor': Color(0xFFFBBF24),
    ...
    // VIP badges
    {
      'id': 'badge_premium',
      'name': 'Premium',
      'desc': 'Active Creaniaa Premium member',
      'icon': '💎',
      'category': 'VIP',
      'rarity': 'Epic',
      'rarityColor': Color(0xFF8B5CF6),
    ...
    // Career badges
    {
      'id': 'badge_hired',
      'name': 'Got Hired',
      'desc': 'Landed a job through Creaniaa referral',
      'icon': '💼',
      'category': 'Career',
      'rarity': 'Legendary',
      'rarityColor': Color(0xFFFBBF24),
      'isUnlocked': false,
      'unlocksAt': 'Get hired via Creaniaa',
      'xpBonus': 500,
    },
    {
      'id': 'badge_100_hiring',
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color: isUnlocked ? rarityColor : context.caption,
                fontSize: 10,
              ),
              maxLines: 1,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 6),
            Icon(Icons.close, size: 12, color: context.caption),
          ],
        ),
      ),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                if (!isUnlocked) ...[
                  SizedBox(height: 10),
                  _detailChip(
                      'Unlock Condition', badge['unlocksAt'] as String, context.accentOrange),
                ],
                SizedBox(height: 24),
                if (isUnlocked)
                  SizedBox(
