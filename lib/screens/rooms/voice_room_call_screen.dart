...
import '../../widgets/profile/mini_profile_widget.dart';
...
import '../../widgets/room/room_dynamic_background_widget.dart';
import '../../widgets/room/room_background_picker_sheet.dart';
...
class _VoiceRoomCallScreenState extends State<VoiceRoomCallScreen>
            ...
            Row(
              children: [
                ...
                _buildTopBarButton(
                  ...
                  onTap: () {
                    Get.dialog(SeatApplicationsDialog(roomId: roomId));
                  },
                ),
                const SizedBox(width: 6),
  ...
  void _insertMention(String username, String targetUserId) {
    ...
    if (currentText.contains(mentionText.trim())) {
      ...
      _chatInputController.selection = TextSelection(
        baseOffset: index,
        extentOffset: index + mentionText.trim().length,
      );
      return;
    }
  ...
  void _showMemberContextMenu(String targetUserId, String targetUserName,
    ...
    final isFollowing = _followedUsers.contains(targetUserId);
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Get.back();
                final conversation = Conversation(
                  id: 'room-${widget.roomId}-$targetUserId',
