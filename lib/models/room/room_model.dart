class VoiceRoom {
  factory VoiceRoom.dummy([String id = '']) => VoiceRoom(
        id: id,
        name: 'Arena Room',
        description: '',
        hostId: '',
  ...
  factory VoiceRoom.fromJson(Map<String, dynamic> json) {
    return VoiceRoom(
      ...
      participantCount: json['participantCount'] ?? json['participant_count'] ?? json['online_members'] ?? 0,
      ...
      totalMembers: json['totalMembers'] ?? json['total_members'] ?? 0,
      ...
      starMemberIds: List<String>.from(json['starMemberIds'] ?? json['star_member_ids'] ?? []),
