...
class StudyVaultController extends GetxController {
  ...
  StudyVaultItem _itemFromMap(Map<String, dynamic> m) {
    return StudyVaultItem(
      ...
      watermarkText: m['watermark_text'] ?? 'Creaniaa',
  ...
  void adminUploadOfficialBook({
    ...
    final newOfficial = StudyVaultItem(
      ...
      coverImage: coverUrl,
      category: category,
      course: 'Creaniaa Official Academy',
      semester: 'N/A',
      branch: 'All Sciences',
      university: 'Creaniaa Board',
      language: 'English',
      tags: [category, 'Official', 'Membership'],
      authorName: 'Creaniaa Authors',
      publisher: 'Creaniaa Press',
      edition: '1st Edition',
      pages: pages,
      fileType: 'Books',
