...
* **4:00 AM IST Daily Reset:** Tasks reset every morning at 04:00 AM IST. Daily progress counters reset to 0 while total XP is preserved permanently.
* **Daily Capping & Weekend 2X Doubling:** Weekday limit = 700 Normal / 1000 Gold (1700 Total); Weekend limit = 1400 Normal / 2000 Gold (3400 Total). Tasks beyond the daily limit grant 0 XP / 0 rewards until 04:00 AM IST reset.
* **Overflow Carry Forward Protection:** Extra progress beyond level requirement carries forward to the next level automatically (e.g. 35,498 + 5 = 35,503 => Level 2 with 3 / 24,000 XP carry-over). Realtime updates reflect immediately without app restart.
